...
switch ( $map_style ) {
	...
	case 'style11':
		...
		break;
	case 'cake-style':
		$map_style_snippet = '[{"featureType":"all","elementType":"labels.text.fill","stylers":[{"saturation":36},{"color":"#333333"},{"lightness":40}]},{"featureType":"all","elementType":"labels.text.stroke","stylers":[{"visibility":"on"},{"color":"#ffffff"},{"lightness":16}]},{"featureType":"all","elementType":"labels.icon","stylers":[{"visibility":"off"}]},{"featureType":"administrative","elementType":"geometry.fill","stylers":[{"color":"#fefefe"},{"lightness":20}]},{"featureType":"administrative","elementType":"geometry.stroke","stylers":[{"color":"#fefefe"},{"lightness":17},{"weight":1.2}]},{"featureType":"administrative.locality","elementType":"geometry.fill","stylers":[{"color":"#d91f1f"}]},{"featureType":"landscape","elementType":"geometry","stylers":[{"color":"#f5f5f5"},{"lightness":20}]},{"featureType":"poi","elementType":"geometry","stylers":[{"color":"#f5f5f5"},{"lightness":21}]},{"featureType":"poi.park","elementType":"geometry","stylers":[{"color":"#d5ebd5"},{"lightness":21}]},{"featureType":"road.highway","elementType":"geometry.fill","stylers":[{"color":"#ffffff"},{"lightness":17}]},{"featureType":"road.highway","elementType":"geometry.stroke","stylers":[{"color":"#ffffff"},{"lightness":29},{"weight":0.2}]},{"featureType":"road.arterial","elementType":"geometry","stylers":[{"color":"#ffffff"},{"lightness":18}]},{"featureType":"road.local","elementType":"geometry","stylers":[{"color":"#ffffff"},{"lightness":16}]},{"featureType":"transit","elementType":"geometry","stylers":[{"color":"#f2f2f2"},{"lightness":19}]},{"featureType":"water","elementType":"geometry","stylers":[{"color":"#e9e9e9"},{"lightness":17}]},{"featureType":"water","elementType":"geometry.fill","stylers":[{"color":"#ebf4ff"}]}]';
		break;
	default:
		$map_style_snippet = '';
}
...
$map_style_snippet = wp_json_encode( $map_style_snippet );

if ( $el_class ) {
	echo 'class="insight-gmaps ' . esc_attr( $el_class ) . '"';
} else {
	echo 'id="map-canvas" class="insight-gmaps"';
}
?>
				...
				if ( gmMapDiv.length ) {
					...
					gmMapDiv.gmap3( {
						...
						marker: {
							...
							options: {
								<?php if ($marker_icon == '') { ?>
								icon: "<?php echo INSIGHT_THEME_URI ?>/assets/images/map-marker.png",
								<?php } else { ?>
							...
							events: {
								click: function( marker, event ) {
									...
									if ( infowindow ) {
										...
										infowindow.setContent( "<?php echo Insight_Helper::esc_js( $content ); ?>" );
									}
									else {
										$( this ).gmap3( {
											infowindow: {
												anchor: marker,
												options: {content: "<?php echo Insight_Helper::esc_js( $content ); ?>"}
											}
										} );
									}
								}
						...
						map: {
							options: {
								...
								styles: <?php echo urldecode( Insight_Helper::base_decode( $map_style_snippet ) ); ?>,
								<?php } ?>
								<?php } else { ?>
