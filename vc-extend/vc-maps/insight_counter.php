...
vc_map( array(
	...
	'description'               => esc_html__( 'Your milestones, achievements, etc.', 'tm-organie' ),
	...
	'params'                    => array(
		...
		array(
			'type'        => 'number',
			'admin_label' => true,
			'heading'     => esc_html__( 'Counter value', 'tm-organie' ),
		...
		array(
			'type'       => 'textfield',
			'heading'    => esc_html__( 'Counter title', 'tm-organie' ),
		...
		array(
			...
			'param_name'  => 'el_class',
			'description' => esc_html__( 'Style particular content element differently - add a class name and refer to it in custom CSS.', 'tm-organie' ),
		),
		array(
			'type'       => 'css_editor',
