...
class Insight_FontIcon {
	...
	public function add_organie( $icons ) {
		$organie = array(
			array( 'organie-apple' => 'apple' ),
			array( 'organie-banana' => 'banana' ),
			array( 'organie-basket' => 'basket' ),
			array( 'organie-blender' => 'blender' ),
			array( 'organie-bread' => 'bread' ),
			array( 'organie-broccoli' => 'broccoli' ),
			array( 'organie-carrot' => 'carrot' ),
			array( 'organie-coconut' => 'coconut' ),
			array( 'organie-corn' => 'corn' ),
			array( 'organie-cucumber' => 'cucumber' ),
			array( 'organie-egg' => 'egg' ),
			array( 'organie-eggplant' => 'eggplant' ),
			array( 'organie-ekobag' => 'ekobag' ),
			array( 'organie-grain' => 'grain' ),
			array( 'organie-grape' => 'grape' ),
			array( 'organie-honey' => 'honey' ),
			array( 'organie-jam' => 'jam' ),
			array( 'organie-leaf' => 'leaf' ),
			array( 'organie-leaves' => 'leaves' ),
			array( 'organie-lemon' => 'lemon' ),
			array( 'organie-lettuce' => 'lettuce' ),
			array( 'organie-milk' => 'milk' ),
			array( 'organie-mushrooms' => 'mushrooms' ),
			array( 'organie-onion' => 'onion' ),
			array( 'organie-pear' => 'pear' ),
			array( 'organie-pepper' => 'pepper' ),
			array( 'organie-radish' => 'radish' ),
			array( 'organie-smoothie' => 'smoothie' ),
			array( 'organie-squeezer' => 'squeezer' ),
			array( 'organie-tomato' => 'tomato' ),
			array( 'organie-watermelon' => 'watermelon' ),
			array( 'organie-hours-support' => 'hours support' ),
			array( 'organie-barn' => 'barn' ),
			array( 'organie-credit-card' => 'credit card' ),
			array( 'organie-delivery' => 'delivery' ),
			array( 'organie-map-location' => 'map location' ),
			array( 'organie-path-footer' => 'path footer' ),
			array( 'organie-tractor' => 'tractor' ),
			array( 'organie-drop' => 'drop' ),
			array( 'organie-decor' => 'decor' ),
			array( 'organie-arrow-01' => 'arrow-01' ),
			array( 'organie-leaves' => 'leaves' ),
			array( 'organie-leaves_2' => 'leaves_2' ),
			array( 'organie-plant' => 'plant' ),
			array( 'organie-plant1' => 'plant1' ),
			array( 'organie-plant-4' => 'plant-4' ),
			array( 'organie-plant-3' => 'plant-3' ),
			array( 'organie-plant-2' => 'plant-2' ),
			array( 'organie-cactus' => 'cactus' ),
			array( 'organie-flower-1' => 'flower-1' ),
			array( 'organie-flower-2' => 'flower-2' ),
			array( 'organie-flower-3' => 'flower-3' ),
			array( 'organie-flower-4' => 'flower-4' ),
			array( 'organie-flower-5' => 'flower-5' ),
			array( 'organie-flower-6' => 'flower-6' ),
			array( 'organie-flower-7' => 'flower-7' ),
			array( 'organie-flower-8' => 'flower-8' ),
			array( 'organie-flower-9' => 'flower-9' ),
			array( 'organie-flower-10' => 'flower-10' ),
			array( 'organie-flower-11' => 'flower-11' ),
			array( 'organie-flower-12' => 'flower-12' ),
			array( 'organie-flower-13' => 'flower-13' ),
			array( 'organie-flower-14' => 'flower-14' ),
		);
